...
mediawiki_api_endpoint = 'http://'+ os.environ['WIKIBASE_NAME'] + '/w/api.php'

# SPARQL endpoint
wikibase_sparql_endpoint = 'http://' + os.environ['WDQS_PUBLIC_HOST'] + '/AVERQUEFALTAAQUI/wdqs/bigdata/namespace/wdq/sparql'

# Name of the Wikibase instance
wikibase_name = os.environ['WIKIBASE_NAME']

# URL of the main page of the Wikibase instance
wikibase_main_page = 'http://' + os.environ['WIKIBASE_NAME'] + '/wiki/Main_Page'
...
identifier_space = 'http://' + os.environ['WIKIBASE_PUBLIC_HOST'] + '/entity/'
schema_space = 'http://'+ os.environ['WIKIBASE_PUBLIC_HOST'] + '/prop/direct/'
...
qid_url_pattern = 'http://' + os.environ['WIKIBASE_PUBLIC_HOST'] + '/wiki/Item:{{id}}'
...
service_name = 'Reconcile for' + os.environ['WIKIBASE_PUBLIC_HOST'] + '.'

# URL (without the trailing slash) where this server runs
this_host = os.environ['RECONCILE_ADDRESS']
